          ...
          if (hasMesh) {
            ...
            if (currentType == "gamepad" || currentType == "joystick") {
              ...
              const char *keys[] = {
                  ...
                  "key_4",          "key_5",           "key_6",
                  "key_7",          "key_8",           "key_9",
                  "key_space",      "key_enter",       "key_shift",
                  "key_rshift",     "key_ctrl",        "key_rctrl",
                  "key_alt",        "key_ralt",        "key_tab",
                  "key_escape",     "key_up",          "key_down",
                  "key_left",       "key_right",       "key_f1",
                  "key_f2",         "key_f3",          "key_f4",
                  "key_f5",         "key_f6",          "key_f7",
                  "key_f8",         "key_f9",          "key_f10",
                  "key_f11",        "key_f12",         "key_f13",
                  "key_f14",        "key_f15",         "key_f16",
                  "key_f17",        "key_f18",         "key_f19",
                  "key_f20",        "key_f21",         "key_f22",
                  "key_f23",        "key_f24",         "key_delete",
                  "key_pageup",     "key_pagedown",    "key_home",
                  "key_end",        "key_insert",      "key_printscreen",
                  "key_scrolllock", "key_pause",       "key_kp_0",
